package com.aidukonis.dogimagegallery.fragment
...
import com.aidukonis.dogimagegallery.helper.GlideApp
import com.aidukonis.dogimagegallery.helper.ZoomOutPageTransformer
    ...
    internal var viewPagerPageChangeListener: ViewPager.OnPageChangeListener =
        object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                // just in case reserved for putting in a title for the pictures
                // (no titles were provided)
